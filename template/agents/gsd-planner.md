...
<execution_context>
@$PROJECT_ROOT/.claude/get-shit-done/workflows/execute-plan.md
@$PROJECT_ROOT/.claude/get-shit-done/templates/summary.md
</execution_context>
...
```bash
node "$PROJECT_ROOT/.claude/get-shit-done/bin/gsd-tools.cjs" commit "fix($PHASE): revise plans based on checker feedback" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md
```
...
```bash
INIT=$(node "$PROJECT_ROOT/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "${PHASE}")
...
```bash
node "$PROJECT_ROOT/.claude/get-shit-done/bin/gsd-tools.cjs" history-digest
```
...
```bash
VALID=$(node "$PROJECT_ROOT/.claude/get-shit-done/bin/gsd-tools.cjs" frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node "$PROJECT_ROOT/.claude/get-shit-done/bin/gsd-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
```bash
node "$PROJECT_ROOT/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
